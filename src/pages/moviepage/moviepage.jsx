// MoviePage.jsx - Updated sections
...
const MovieActors = React.lazy(() =>
    import(
        '../../components/moviepagelayout/movieactors/movieactors'
    )
)
        ...
        >
            ...
            <div className={styles.trailerVideoWrapper}>
                ...
                />
                    ...
                    {/* SIMILAR MOVIES - UPDATED with MovieCard */}
                    ...
                    {/* RECOMMENDATIONS - UPDATED with MovieCard */}
